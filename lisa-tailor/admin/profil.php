...
if($_POST['simpan']) {
	...
	$sql = mysql_query("UPDATE informasi SET profil = '$profil' WHERE id = '$informasi->id'");
	# Pesan Sukses
	$pesan = '
...
<div class="col-sm-9">	
	<div class="breadcrumb">
		...
		» <a href="#">Toko</a>
		» <a href="#" class="last">Profil</a>
	</div>
	<form action="" method="POST" class="contact-info" style="padding: 10px;">
		<?=(isset($pesan))?$pesan:'';?>
		<textarea id="summernote" name="profil"><?=$informasi->profil?></textarea>
